...
def create_model():
    ...
    inception_3a_pool = ZeroPadding2D(padding=((1, 1),(1,1)))(inception_3a_pool)
    ...
    inception_3b_pool = AveragePooling2D(pool_size=(3, 3), strides=1)(inception_3a)
    inception_3b_pool = Conv2D(64, (1, 1), name='inception_3b_pool_conv')(inception_3b_pool)
    inception_3b_pool = BatchNormalization(axis=3, epsilon=0.00001, name='inception_3b_pool_bn')(inception_3b_pool)
    inception_3b_pool = Activation('relu')(inception_3b_pool)
    inception_3b_pool = ZeroPadding2D(padding=((1, 1),(1,1)))(inception_3b_pool)
    ...
    inception_4a_pool = AveragePooling2D(pool_size=(3, 3), strides=1)(inception_3c)
    ...
    inception_5a_pool = AveragePooling2D(pool_size=(3, 3), strides=1)(inception_4e)
    ...
    inception_5b_pool = utils.conv2d_bn(inception_5b_pool,
                                        ...
                                        cv1_out=96,
                                        cv1_filter=(1, 1))
    inception_5b_pool = ZeroPadding2D(padding=((1, 1),(1, 1)))(inception_5b_pool)
...
def create_base_network(input_shape):
    ...
    new_mod.load_weights('weights/no_top_openface_input_192x192.h5')
    return new_mod
